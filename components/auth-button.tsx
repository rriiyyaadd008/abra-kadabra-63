...
export function AuthButton() {
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="sm" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">{session.user.username || session.user.name}</span>
          </Button>
        </DropdownMenuTrigger>
  ...
  return (
    <Button variant="outline" size="sm" onClick={() => signIn("discord")} className="flex items-center gap-2">
